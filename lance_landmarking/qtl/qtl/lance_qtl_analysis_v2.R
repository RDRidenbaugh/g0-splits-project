# previously: setwd("~/Academia/Ovipositor_QTL/LancePartyUSA/phenotype_genotype/qtl")
setwd("//wsl.localhost/Ubuntu/home/labradorite/g0-splits-project/lance_landmarking/qtl/qtl")
...
LBX_Sut6_Length_Right.df <- as.data.frame(LBX_Sut6_Length_Right)
Sut6_to_Ann_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Sut6_Length_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Sut6_to_Ann_right)
...
LBX_Arc5_Width_Right.df <- as.data.frame(LBX_Arc5_Width_Right)
Arc5_to_length_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Arc5_Width_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Arc5_to_length_right)
...
LBX_Rail_Height_Right.df <- as.data.frame(LBX_Rail_Height_Right)
RailHeight_to_Ann_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Rail_Height_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(RailHeight_to_Ann_right)
...
LBX_RightFace_Height2.scanone.perm<-scanone(LBX_Right,method="hk",pheno.col="Rightface_height2", addcovar=LBX_Right_CoVar_Body, n.perm=1000)
...
LBX_RightFace_Height1.df <- as.data.frame(LBX_RightFace_Height1)
LBX_RightFace_Height2.df <- as.data.frame(LBX_RightFace_Height2)
LBX_RightFace_Height7.df <- as.data.frame(LBX_RightFace_Height7)
RightFace_Height_to_Ann_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_RightFace_Height1.df, color = "coral1", linewidth = 1) + 
  geom_line(data = LBX_RightFace_Height2.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = LBX_RightFace_Height7.df, color = "springgreen2", linewidth = 1) +
  geom_line(data = Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(RightFace_Height_to_Ann_right)
...
LBX_Comp1_Left.df <- as.data.frame(LBX_Comp1_Left)
LBX_Comp3_Left.df <- as.data.frame(LBX_Comp3_Left)
LBX_Comp6_Left.df <- as.data.frame(LBX_Comp6_Left)
LBX_Comp10_Left.df <- as.data.frame(LBX_Comp10_Left)

shape_to_length_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Comp1_Left.df, color = "coral1", linewidth = 1) + 
  geom_line(data = LBX_Comp3_Left.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = LBX_Comp6_Left.df, color = "springgreen2", linewidth = 1) +
  geom_line(data = LBX_Comp10_Left.df, color = "goldenrod2", linewidth = 1) +
  geom_line(data = BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(shape_to_length_left)

shape_to_width_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Comp1_Left.df, color = "coral1", linewidth = 1) + 
  geom_line(data = LBX_Comp3_Left.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = LBX_Comp6_Left.df, color = "springgreen2", linewidth = 1) +
  geom_line(data = LBX_Comp10_Left.df, color = "goldenrod2", linewidth = 1) +
...
LBX_Centroid_Size_Left.df <- as.data.frame(LBX_Centroid_Size_Left)
size_to_length_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Centroid_Size_Left.df, color = "coral1", linewidth = 1) + 
  geom_line(data = BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(size_to_length_left)
...
LBX_Sut2_Length_Left.df <- as.data.frame(LBX_Sut2_Length_Left)
LBX_Sut3_Length_Left.df <- as.data.frame(LBX_Sut3_Length_Left)
Sut_to_width_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Sut2_Length_Left.df, color = "coral1", linewidth = 1) + 
  geom_line(data = LBX_Sut3_Length_Left.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Sut_to_width_left)
...
LBX_Noncut_Edge_Length_Left.df <- as.data.frame(LBX_Noncut_Edge_Length_Left)
Edge_to_width_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Noncut_Edge_Length_Left.df, color = "coral1", linewidth = 1) + 
  geom_line(data = Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Edge_to_width_left)
...
LBX_Leftface_Height5.df <- as.data.frame(LBX_Leftface_Height5)
Height_to_width_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = LBX_Leftface_Height5.df, color = "coral1", linewidth = 1) + 
  geom_line(data = Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Height_to_width_left )
...
## PBX Saw QTL ##
PBX_Saw<-read.cross(format="csv",file="PBX_25kb_2024_qtl.csv",crosstype ="bc",na.strings="NA",genotypes=c("AA","AB"), estimate.map=FALSE)
PBX_Saw<-jittermap(PBX_Saw)

PBX_Saw <- calc.genoprob(PBX_Saw, step=0, error.prob = 0.01, map.function = "kosambi",stepwidth = "fixed")
PBX_Saw_Fam <- as.numeric(pull.pheno(PBX_Saw, pheno.col="Family"))

#families with one individual are not meaningful covariates; reduce to only those with >1
#first count number in each site
#test<-as.data.frame(cbind(PBX_Saw$pheno$ID,PBX_Saw_Fam))
#test%>%count(as.factor(PBX_Saw_Fam))
#exclude families 12, 16,17as covariates

PBX_Saw_Fam1 <-as.numeric(PBX_Saw_Fam == 1)
PBX_Saw_Fam2 <- as.numeric (PBX_Saw_Fam == 2)
PBX_Saw_Fam3 <- as.numeric (PBX_Saw_Fam == 3)
PBX_Saw_Fam4 <- as.numeric (PBX_Saw_Fam == 4)
#PBX_Saw_Fam5 <- as.numeric (PBX_Saw_Fam == 5)
PBX_Saw_Fam6 <- as.numeric (PBX_Saw_Fam == 6)
PBX_Saw_Fam7 <- as.numeric (PBX_Saw_Fam == 7)
PBX_Saw_Fam8 <- as.numeric (PBX_Saw_Fam == 8)
PBX_Saw_Fam9 <- as.numeric (PBX_Saw_Fam == 9)
PBX_Saw_Fam10 <- as.numeric (PBX_Saw_Fam == 10)

PBX_Saw_Fam_X <- cbind(PBX_Saw_Fam1,PBX_Saw_Fam2,PBX_Saw_Fam3,PBX_Saw_Fam4,PBX_Saw_Fam6,PBX_Saw_Fam7,PBX_Saw_Fam8,PBX_Saw_Fam9,PBX_Saw_Fam10)
PBX_Saw_Host <- as.numeric(pull.pheno(PBX_Saw, pheno.col="WhiteChoice"))
PBX_Saw_BodySize <- as.numeric(pull.pheno(PBX_Saw, pheno.col="leg_length"))

PBX_Saw_CoVar_Host <- cbind(PBX_Saw_Host, PBX_Saw_Fam_X)
PBX_Saw_CoVar_Body <-cbind(PBX_Saw_BodySize, PBX_Saw_Fam_X)
PBX_Saw_CoVar_All <-cbind (PBX_Saw_Host, PBX_Saw_BodySize, PBX_Saw_Fam_X)

# Bottom Length
PBX_BottomLengthLM<-scanone(PBX_Saw, pheno.col="BottomLengthLM", method="hk", model="normal", addcovar=PBX_Saw_CoVar_Body)
plot(PBX_BottomLengthLM)

# Ann2LM
PBX_Ann2LM<-scanone(PBX_Saw, pheno.col="Ann2LM", method="hk", model="normal", addcovar=PBX_Saw_CoVar_Body)
plot(PBX_Ann2LM)

# Ann8LM
PBX_Ann8LM<-scanone(PBX_Saw, pheno.col="Ann8LM", method="hk", model="normal", addcovar=PBX_Saw_CoVar_Body)
plot(PBX_Ann8LM)

# Centroid
PBX_landmarks_centroid<-scanone(PBX_Saw, pheno.col="landmarks_centroid", method="hk", model="normal", addcovar=PBX_Saw_CoVar_Body)
plot(PBX_landmarks_centroid)

PBX_BottomLengthLM.df <- as.data.frame(PBX_BottomLengthLM)
PBX_Ann2LM.df <- as.data.frame(PBX_Ann2LM)
PBX_Ann8LM.df <- as.data.frame(PBX_Ann8LM)
PBX_landmarks_centroid.df <- as.data.frame(PBX_landmarks_centroid)
...
PBX_Comp1_Right.df <- as.data.frame(PBX_Comp1_Right)
PBX_Comp5_Right.df <- as.data.frame(PBX_Comp5_Right)
PBX_Comp7_Right.df <- as.data.frame(PBX_Comp7_Right)
PBX_Comp11_Right.df <- as.data.frame(PBX_Comp11_Right)
shape_to_length_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Comp1_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_Comp5_Right.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = PBX_Comp7_Right.df, color = "springgreen2", linewidth = 1) +
  geom_line(data = PBX_Comp11_Right.df, color = "goldenrod2", linewidth = 1) +
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(shape_to_length_left)

shape_to_ann_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Comp1_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_Comp5_Right.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = PBX_Comp7_Right.df, color = "springgreen2", linewidth = 1) +
  geom_line(data = PBX_Comp11_Right.df, color = "goldenrod2", linewidth = 1) +
  geom_line(data = PBX_Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(shape_to_ann_left)
...
PBX_Centroid_Size_Right.df <- as.data.frame(PBX_Centroid_Size_Right)
centroid_to_length_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Centroid_Size_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(centroid_to_length_left)
...
PBX_Cutwindow_Length_Right.df <- as.data.frame(PBX_Cutwindow_Length_Right)
PBX_Window_to_Edge1_Right.df <- as.data.frame(PBX_Window_to_Edge1_Right)
cutwindow_to_length_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Cutwindow_Length_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_Window_to_Edge1_Right.df, color = "steelblue1", linewidth = 1) +
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(cutwindow_to_length_left)
...
PBX_Sut5_Length_Right.df <- as.data.frame(PBX_Sut5_Length_Right)
Sut5_to_ann_left <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Sut5_Length_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_Ann2LM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_Ann8LM.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Sut5_to_ann_left)
...
PBX_Arc1_Width_Right.df <- as.data.frame(PBX_Arc1_Width_Right)
Arc1_to_length_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Arc1_Width_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Arc1_to_length_right)
...
PBX_Rightface_Length.df <- as.data.frame(PBX_Rightface_Length)
length_to_length_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Rightface_Length.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(length_to_length_right)
...
PBX_Cut_Edge_Length.df <- as.data.frame(PBX_Cut_Edge_Length)
edgelength_to_length_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Cut_Edge_Length.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(edgelength_to_length_right)
...
PBX_Dist_Arc4_Arc5_Right.df <- as.data.frame(PBX_Dist_Arc4_Arc5_Right)
Arc4_Arc5_to_length_right <- ggplot(NULL, aes(pos, lod)) + 
  geom_line(data = PBX_Dist_Arc4_Arc5_Right.df, color = "coral1", linewidth = 1) + 
  geom_line(data = PBX_BottomLengthLM.df, color = "azure3", linewidth = 1) +
  geom_line(data = PBX_landmarks_centroid.df, color = "azure4", linewidth = 1) +
  facet_grid(.~ chr, scales = "free_x") +
  theme_classic()
print(Arc4_Arc5_to_length_right)
