...
R=/home/labradorite/g0-splits-project/lance_landmarking/cnn/runs/protocol_comparison_r2
D=/home/labradorite/g0-splits-project/genai_lance_landmarking/analysis/data/hard_r2
...
for v in Right Left; do for p in old new newdistal; do for set in hard easy; do
  OMP_NUM_THREADS=${1:-4} $PY /home/labradorite/g0-splits-project/genai_lance_landmarking/cnn/predict_images.py \
